...
st.sidebar.image("https://cloudfront-us-east-1.images.arcpublishing.com/gray/63NKVNATJNFRHLXNGMCSAPPV5U.gif")
submit = st.sidebar.button("Weather Temperature")
if submit:
    st.title(f"Weather Central")
